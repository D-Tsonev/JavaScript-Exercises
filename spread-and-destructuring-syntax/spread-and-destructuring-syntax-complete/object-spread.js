...
const employedDuck = { ...duck, job: 'sailor' }

console.log('original', duck)
console.log('new', employedDuck)
...
console.log('mereged object ', mergedObject)
